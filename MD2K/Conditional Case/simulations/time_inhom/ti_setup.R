...
P.weekend = P; P.weekend[2,] = c(0.6,0.4)

eig.Pwkend = eigen(P.weekend)

pi.wkend = (eig.Pwkend$vectors%*%diag(c(1,0))%*%solve(eig.Pwkend$vectors))[1,]  # Stationary distribution for P
