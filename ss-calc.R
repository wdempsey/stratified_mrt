...
ss.calc <- function(tau, d) {
  ...
  sigmasq.1 = 0.004# #mean(sigma.output1,na.rm = TRUE)
  sigmasq.2 = 0.004# #mean(sigma.output2,na.rm = TRUE)
...
#   ss.answer1 = sample.size(b1%*%solve(sigmasq.1* Sigma.1, b1),p = 3,q = 9)
#   
#   ss.answer2 = sample.size(b2%*%solve(sigmasq.2* Sigma.2, b2),p = 3,q = 9)
